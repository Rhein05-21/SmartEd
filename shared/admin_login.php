        ...
        <div class="forms-container">
            <form class="form sign-in-form active" method="POST" autocomplete="off">
                ...
                <div class="w-full space-y-6 mt-6">
                    <input type="text" name="login_admin_id" placeholder="Admin ID" class="w-full px-0 py-2 border-0 border-b-2 border-gray-200 focus:border-gray-400 bg-transparent text-lg focus:outline-none" required>
                    ...
                    <button type="submit" class="w-full bg-gray-800 text-gray-100 py-3 rounded-full font-semibold text-lg hover:bg-gray-300 hover:text-gray-800 transition">Log in</button>
                </div>
