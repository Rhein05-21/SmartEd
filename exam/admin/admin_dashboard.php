...
try {
    ...
    // Fetch recent exam notifications (limit to latest 10)
    $stmt = $pdo->query("SELECT * FROM exam_notifications ORDER BY created_at DESC LIMIT 10");
    $exam_notifications = $stmt->fetchAll(PDO::FETCH_ASSOC);

    $unread_count = 0;
    foreach ($exam_notifications as $notif) {
                ...
                <div class="notification-wrapper">
                    ...
                    <div class="notification-dropdown" id="notificationDropdown">
                        ...
                        <div class="notification-list">
                            <?php if (count($exam_notifications) > 0): ?>
                                <?php foreach ($exam_notifications as $notif): ?>
